...
import {OpenWeatherAction, WeatherStackAction, WeatherStackDefaultAction} from '../../redux/reducers/weather-Info/weather-info.actions';
...
export class WeatherStackComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.store$.select(selectWeatherStackInfo)
